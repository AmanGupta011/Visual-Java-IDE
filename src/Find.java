...
public class Find extends JFrame implements ActionListener {
    ...
    int startIndex=0;
    int select_start=-1;
    JLabel lab1, lab2; // initialising labels
    JTextField textF, textR; // initialising text fields to enter find and replace words
    JButton findBtn, findNext, replace, replaceAll, cancel; // initialising buttons
    private JTextArea txt; // initialising text area
